...
-- Q1. What is the total revenue generated by male vs female custmers ?
...
select item_purchased as Products ,round(avg(review_rating),2) as Average_Product_Rating
from customer
